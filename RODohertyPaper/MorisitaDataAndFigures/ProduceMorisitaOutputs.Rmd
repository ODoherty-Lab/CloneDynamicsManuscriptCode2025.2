...
library(openxlsx)
write.xlsx(simpleObjectSheets, file=paste0(base, "/MorisitaDataAndFigures/SuppData/SupplementaryData7.xlsx"),rowNames=F, colNames=FALSE) # note due to rounding off each timepoints, the timepoint differences may be 0.1 off from rounded true differences recorded in true Supp Data 7.
