base = here::here()
pathToSuppData1 = paste0(base, "/MorisitaDataAndFigures/SuppData/Supplementary Data 1-ClonesTables.xlsx")
pathToSuppData2 = paste0(base, "/MorisitaDataAndFigures/SuppData/Supplementary Data 2-TCRsSequenced.xlsx")
